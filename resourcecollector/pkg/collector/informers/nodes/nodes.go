...
func NewNodesInformer(client client.Interface, reSyncPeriod time.Duration, name string, key string) cacheinterface.SharedInformer {
...
func (f *informerNodes) defaultInformer(client client.Interface, resyncPeriod time.Duration, name string, key string) cacheinterface.SharedInformer {
	if f.period > 0 {
...
func (f *informerNodes) Informer() cacheinterface.SharedInformer {
