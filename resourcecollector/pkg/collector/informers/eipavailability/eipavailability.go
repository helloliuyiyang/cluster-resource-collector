...
func NewEipInformer(client client.Interface, resyncPeriod time.Duration, name string, key string) cacheinterface.SharedInformer {
...
func (f *informerEipAvailability) defaultInformer(client client.Interface, resyncPeriod time.Duration, name string, key string) cacheinterface.SharedInformer {
	if f.period > 0 {
...
func (f *informerEipAvailability) Informer() cacheinterface.SharedInformer {
