...
func NewVolumePoolInformer(client client.Interface, resyncPeriod time.Duration, name string, key string) cacheinterface.SharedInformer {
...
func (f *informerVolumePool) defaultInformer(client client.Interface, resyncPeriod time.Duration, name string, key string) cacheinterface.SharedInformer {
	if f.period > 0 {
...
func (f *informerVolumePool) Informer() cacheinterface.SharedInformer {
