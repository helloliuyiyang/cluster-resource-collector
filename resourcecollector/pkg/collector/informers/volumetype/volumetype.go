...
func NewVolumeTypeInformer(client client.Interface, resyncPeriod time.Duration, name string, key string) cacheinterface.SharedInformer {
...
func (f *informerVolumeType) defaultInformer(client client.Interface, resyncPeriod time.Duration, name string, key string) cacheinterface.SharedInformer {
	if f.period > 0 {
...
func (f *informerVolumeType) Informer() cacheinterface.SharedInformer {
