...
import (
	...
	"k8s.io/kubernetes/resourcecollector/pkg/collector/utils/clock"
	"k8s.io/kubernetes/resourcecollector/pkg/collector/utils/runtime"
)
...
func BackoffUntil(f func(), backoff BackoffManager, sliding bool, stopCh <-chan struct{}) {
	...
	for {
		...
		case _, ok := <-stopCh:
			if !ok {
				fmt.Printf("the channel entityChan has been closed\n")
				return
			}
			return
		default:
